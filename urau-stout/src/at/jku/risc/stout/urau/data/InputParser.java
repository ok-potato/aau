...
public class InputParser {
    ...
    public InputParser(EquationSystem system) {
        this.system = system;
    }
    ...
    private void parseEquationSequence(Reader in, boolean left, boolean right, boolean increment) throws IOException, MalformedTermException {
        do {
            AntiUnifyProblem eq = increment ? system.newEquation() : system.getLast();
