...
import at.jku.risc.stout.aau.ProximityRelation;
import at.jku.risc.stout.aau.term.GroundTerm;
import at.jku.risc.stout.aau.term.MappedVariableTerm;
...
public class Parser {
    ...
    private static List<Set<Integer>> parseArgumentRelation(String argRelationString) {
        ...
        return Data.mapToList(argRelationsIndexed, ArraySet::of);
    }
